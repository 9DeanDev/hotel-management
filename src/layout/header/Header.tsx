...
import { Button, CustomDatePicker, CustomDropdown, CustomModal } from "../../components";
...
export const Header = () => {
    ...
    const itemBarStyles: Partial<IButtonStyles> = {
        label: { fontSize: 24, color: '#957554' },
    };
    ...
    const checkForm = () => {
        return (
            <CustomModal isOpen={openCheckForm} onDismiss={() => isOpenCheckForm(false)}>
    ...
    return (
        <div className={styles.header}>
            ...
            <Stack horizontal horizontalAlign="center" wrap verticalAlign="center">
                <CommandBar items={itemBar} buttonAs={CustomBarButton} />
            </Stack>
